...
export default class CalendarGrid extends React.Component {
  ...
  getPreviousMonth = () => {
    ...
    return currentMonth.subtract(1, 'M').format('MMMM YYYY');
  };
  ...
  getNextMonth = () => {
    const currentMonth = this.props.focusedDate.clone();
    return currentMonth.add(1, 'M').format('MMMM YYYY');
  };
      ...
      >
        {isMobile ?
          <button
            ...
            <CloseIcon unstyled className={styles.closeButtonIcon}/>
          </button> :
          null
        }
        ...
        <div className={styles.gridTitle}>
          ...
          <h1 className={styles.gridTitleMonth}>
