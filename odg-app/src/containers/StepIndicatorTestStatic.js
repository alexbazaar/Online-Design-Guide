    ...
    <div className={styles.breadCrumbTestPage}>
      ...
      <FlexContainer>
        ...
        <FlexRow justify="center">
          <StepIndicator>
            <StepIndicatorItem stepNum="1" title="About you" status="active">
                About You
            </StepIndicatorItem>
            <StepIndicatorItem stepNum="2" title="Results">
                Results
            </StepIndicatorItem>
          </StepIndicator>
        </FlexRow>
        <FlexRow>
          <Panel className={docStyles.fullWidth}>
            ...
            <button type="button" className={docStyles.StepIndicatorBtnNext} name="Next" onClick={(e) => { e.preventDefault(); window.location.href = '/StepStatic2'; }} tabIndex="0">Next</button>
          </Panel>
        </FlexRow>
      </FlexContainer>
    </div>
