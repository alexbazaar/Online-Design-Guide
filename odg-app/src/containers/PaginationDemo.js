...
import paginationStyles from "../styles/PaginationDemo.scss";
      ...
      <MainContentTemplate className={styles.PaginationTest} id="main-content" hasFullWidthStyle>
        ...
        <Panel padding="large" maxheight="medium">
          <div style={{ minHeight: "70vh" }}>
            <TestPage backURL="/components/pagination">
              <Pagination
...
export default withRouter(EmbedStyles(styles, paginationStyles)(PaginationDemo));
