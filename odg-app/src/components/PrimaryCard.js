 ...
 * *****************************************************************************
 */
function PrimaryCardPage() {
  return (
    <div>
      <Helmet title="Primary card" />
      <DocsPage
        className="docs-styles"
        title="Primary card"
        subtitle="A styled container for content with an option to add images."
        emphasisTag={[ "IRAP APPROVED" ]}
      >
        <DocsSection>
          <TabView id="preview-tabs">
            <Tab label="Preview">
              <Panel maxheight="medium" className="clearfix">
            ...
            <Tab label="Spacing">
              <Panel>
                <img
                  src={CardPrimarySpacing}
                  alt="This is a marked up graphic of the Card spacing with image inset"
                  aria-hidden="true"
        ...
        <DocsSection title="When to use">
          <p> Primary cards have a thick, top border in gold and thin, gray borders for the other three sides. These cards also have the option to 
          include an image. If both primary and secondary card styles are needed in a design, the primary content would use the primary card style. 
          Primary cards should be used when an image is required. Otherwise, either a primary or a secondary card (or both) can be used depending on 
          the design style and need.</p>
        ...
        <DocsSection title="Specifications">
          <h3>Typography</h3>
          <Table
            caption="Primary Card Typography Specifications"
          >
            <thead>
              <TableRow>
          ...
          <h3>Card elements</h3>
          <Table
            caption="Primary Card Elements Specifications"
          >
            <thead>
              <TableRow>
          ...
          <h3>Focus state</h3>
          <Table caption="Primary Card Focus State Specifications">
            <thead>
              <TableRow>
                <TableHeaderCell scope="col">Property</TableHeaderCell>
                <TableHeaderCell scope="col">Value</TableHeaderCell>
        ...
        <DocsSection title="Accessibility guidance">
          <List>
            ...
            <ListItem>
            To support region navigation with JAWS region shortcut, use <code>&#60;article&#62;</code> element for each card in conjunction with 
              <code>aria-labelledby</code> attribute to tie the <code>&#60;article&#62;</code> elements to the text shown in the heading for a particular card.
            </ListItem>
            <ListItem>
...
export default EmbedStyles(styles)(PrimaryCardPage);