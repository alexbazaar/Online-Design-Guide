 ...
 * *****************************************************************************
 */
export default function InteractiveStepIndicatorPage() {
  const imgStyle = {
    width: "100%",
    maxWidth: "400px",
    margin: "0 auto",
  ...
  return (
    <div>
      <Helmet title="Interactive step indicator" />
      <DocsPage
        className="docs-styles"
        title="Interactive step indicator"
        subtitle="Interactive progress tracker comprised of connected steps and labels."
      ...
      >
        ...
        <DocsSection title="Description">
          <p>Interactive progress tracker comprised of connected steps and labels. 
            Steps and labels link the user to different pages or sections while also 
            visually tracking their progress.
          </p>
          <p>The first example (above, top) is a fully interactive, selectable step 
            indicator. Completed and future steps are selectable. Active steps would 
            not be selectable since that would be the current page showing. Note: The 
            content of the HTML and CSS tabs correspond to this example.
          </p>
          <p>The second example (above, bottom) is an interactive, partially selectable 
            step indicator where past steps are selectable and future steps are disabled. 
            Active steps would not be selectable since that would be the current page showing.
          </p>
        </DocsSection>

        <DocsSection title="When to use">
          <p>Use an interactive step indicator when the application <i style={{ fontStyle: "italic" }}>allows</i> the user to navigate 
        ...
        <DocsSection title="Specifications">
          ...
          <Table caption="Interactive step indicator typography (on desktop) specifications">
            <thead>
              <TableRow>
            ...
            <tbody>
              <TableRow>
                <TableHeaderCell>Step number (default, active)</TableHeaderCell>
                <TableCell>
                  18px
                </TableCell>
                <TableCell>
              ...
              <TableRow>
                <TableHeaderCell>Step number (disabled)</TableHeaderCell>
                <TableCell>
                  18px
                </TableCell>
                <TableCell>
              ...
              <TableRow>
                <TableHeaderCell>Content label (hover)</TableHeaderCell>
                <TableCell>
                  14px
                </TableCell>
                <TableCell>
          ...
          <Table caption="Interactive step indicator typography (on mobile) specifications">
            <thead>
              <TableRow>
                <TableHeaderCell scope="col">Context</TableHeaderCell>
                <TableHeaderCell scope="col">Reference</TableHeaderCell>
          ...
          <p>
          Each step indicator knot, or step, has a status that affects its styling: 
          completed, active, disabled or default. The background color, box shadow 
          (or border) color and line color (connecting the knots) dynamically changes 
          based on step indicator's status.
          </p>

          <h3>Elements: Step (desktop)</h3>
          <Table caption="Interactive step indicator elements (on desktop) specifications">
            <thead>
              <TableRow>
            ...
            <tbody>
              <TableRow>
                <TableHeaderCell>Circle</TableHeaderCell>
              ...
              <TableRow>
                <TableHeaderCell>Background (completed, default)</TableHeaderCell>
                <TableCell>N/A</TableCell>
                <TableCell>
                  <Link to="/styles/colors">Blue</Link>
                </TableCell>
              ...
              <TableRow>
                <TableHeaderCell>Background (hover, active)</TableHeaderCell>
                <TableCell>N/A</TableCell>
                <TableCell>
                  <Link to="/styles/colors">Blue dark</Link>
                </TableCell>
              ...
              <TableRow>
                <TableHeaderCell>Background (disabled)</TableHeaderCell>
                <TableCell>N/A</TableCell>
                <TableCell>
                  <Link to="/styles/colors">White</Link>
                </TableCell>
              ...
              <TableRow>
                <TableHeaderCell>Box shadow (disabled)</TableHeaderCell>
          ...
          <Table caption="Interactive step indicator elements (on mobile) specifications">
            <thead>
              <TableRow>
                <TableHeaderCell scope="col">Property</TableHeaderCell>
                <TableHeaderCell scope="col">Value</TableHeaderCell>
          ...
          <Table caption="Interactive step indicator icon elements (on desktop) specifications">
            <thead>
              <TableRow>
                <TableHeaderCell scope="col">Property</TableHeaderCell>
                <TableHeaderCell scope="col">Value</TableHeaderCell>
            ...
            <tbody>
              <TableRow>
                <TableHeaderCell>Icon (check, default)</TableHeaderCell>
                <TableCell>
              ...
              <TableRow>
                <TableHeaderCell>Icon (check, disabled)</TableHeaderCell>
                <TableCell>
                  <Link to="/styles/iconography">check-solid</Link>
                </TableCell>
                <TableCell>
          ...
          <Table caption="Interactive step indicator icon elements (on mobile) specifications">
            <thead>
              <TableRow>
                <TableHeaderCell scope="col">Property</TableHeaderCell>
                <TableHeaderCell scope="col">Value</TableHeaderCell>
          ...
          <h3>Focus state</h3>
          <Table caption="Interactive step Indicator Focus State Specifications">
            <thead>
              <TableRow>
                <TableHeaderCell scope="col">Property</TableHeaderCell>
                <TableHeaderCell scope="col">Value</TableHeaderCell>
        ...
        <DocsSection title="Accessibility guidance">
          <List>
            ...
            <ListItem>
                If possible, provide a link to steps already completed, so the user can 
                review them. In this case, any data already entered in the current step should be saved. 
            </ListItem>
            <ListItem>
                Enclose the step indicator in a <code>{"<nav>"}</code> element. Your progress indicator 
                would be similar to a <ExternalLink href="https://www.w3.org/WAI/ARIA/apg/patterns/breadcrumb/">breadcrumb trail</ExternalLink>. 
                The nav should also have an aria-label and the current 
                step in the process should have <ExternalLink href="https://w3c.github.io/aria/#aria-current"><code>aria-current="true"</code></ExternalLink>. Using <code>aria-label="progress"</code> 
                helps provide context to assistive technologies.
            </ListItem>
            <ListItem>
                On small screens, consider hiding step labels and showing only step indicators.
            </ListItem>
            <ListItem>
                The target size of the interactive step should be at least 44 by 44 CSS pixels.
            </ListItem>
          </List>
